...
with st.container(border=True):
    st.markdown("### 🤖 How to Generate Ideas")
    st.info(
        "Idea generation runs in your **Claude Code session** using VidIQ MCP + YouTube browser research. "
        "Say *'generate F&R ideas'* in Claude Code — it will research signals and add ranked ideas directly to this pipeline. "
        "You can also add ideas manually below."
    )
